...
export default function DocumentDetailPage() {
  ...
  const shareWhatsApp = async () => {
    ...
    const msg = `${doc?.jobTitle || 'My tailored CV'} — made with CVBoost AI. Check it out: ${target}`;
      ...
      <div className="mb-8">
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button onClick={shareWhatsApp} className="btn-ghost text-sm flex items-center gap-1.5 text-emerald-600 hover:text-emerald-700" title="Share on WhatsApp">
            ...
            <button onClick={() => handleDownload('pdf')} disabled={downloading} className="btn-ghost text-sm flex items-center gap-1.5" title="Download PDF">
