          ...
          <nav className="hidden sm:flex items-center gap-1" aria-label="Main navigation">
            ...
            {user ? (
              <>
                ...
                <Link to="/jobs" className="btn-ghost text-sm no-underline">{t('nav.jobs')}</Link>
          ...
          <nav className="sm:hidden pb-4 animate-slide-up border-t border-surface-100 dark:border-surface-700 mt-1 pt-3 space-y-1" aria-label="Mobile navigation">
            ...
            {user ? (
              <>
                ...
                <Link to="/jobs" onClick={() => setMenuOpen(false)} className="block px-3 py-2 rounded-lg text-sm text-surface-600 dark:text-surface-300 hover:bg-surface-100 dark:hover:bg-surface-800 no-underline">
                  {t('nav.jobs')}
                </Link>
                ...
                <Link to="/notifications" onClick={() => setMenuOpen(false)} className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-surface-600 dark:text-surface-300 hover:bg-surface-100 dark:hover:bg-surface-800 no-underline">
                  {t('nav.notifications')}
                </Link>
              ...
              <>
                <Link to="/jobs" onClick={() => setMenuOpen(false)} className="block px-3 py-2 rounded-lg text-sm text-surface-600 dark:text-surface-300 hover:bg-surface-100 dark:hover:bg-surface-800 no-underline">{t('nav.jobs')}</Link>
